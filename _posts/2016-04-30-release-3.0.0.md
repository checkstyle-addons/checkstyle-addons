...
We have a new check called [ModuleDirectoryLayout](http://checkstyle-addons.thomasjensen.com/v3.0.0/checks/misc.html#ModuleDirectoryLayout) which helps ensure that the modules of project follow a configurable directory layout.<!--break-->
