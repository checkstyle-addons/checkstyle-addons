...
COPY --chown=sonarqube:sonarqube build/libs/checkstyle-addons-${CS_ADDONS_VERSION_EXT}-sonar.jar /opt/sonarqube/extensions/plugins/
RUN chmod 644 /opt/sonarqube/extensions/plugins/checkstyle-addons-*
